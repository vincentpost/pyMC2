...
class Tracer:
    def __init__(self, name, C_0, C_rain):
        self.name = name
        self.C_0 = C_0
        self.C_rain = C_rain

class Isotope(Tracer):
    def __init__(self, name, C_0, C_rain, C_atm):
        super().__init__(name, C_0, C_rain)
        self.C_atm = C_atm
    ...
    def delta_e(self, Tc, RH, delta_w):
        delta_atm = self.C_atm
